...
<body>
    ...
    <div class="all-content-wrapper">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header header-color-modal bg-color-1">
                      <h4 class="modal-title">  ODONTOLOGIA</h4>
                      <div class="modal-close-area modal-close-df">
                          <a class="close" data-dismiss="modal" href="#"><i class="fa fa-close"></i></a>
                      </div>
                  </div>
                    <form id="form_add_dientes" method="POST" >
                    <div class="modal-body">
                      <div class="row">
                          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group" id="div_id_dientes" hidden  >
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                  <input name="numero" id="numero" type="number" class="form-control" placeholder="numero" value="" required>
                              </div>
                          </div>
                      </div>
                    </div>
                      ...
                      <div class="sparkline13-list">
                          ...
                          <div class="sparkline13-graph">
                              <div class="table-responsive datatable-dashv1-list custom-datatable-overright">
                                  <table id="table_dientes" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                      <thead>
                                          <tr>
                                              <th>#</th>
                                              <th>Creado</th>
        ...
        <!-- paciente JS
    		============================================ -->
        <script src="ajax/dientes.js"></script>
