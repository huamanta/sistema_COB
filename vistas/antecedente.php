...
<body>
    ...
    <div class="all-content-wrapper">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header header-color-modal bg-color-1">
                    ...
                    <form id="form_add_antecedente" method="POST" >
                    <div class="modal-body">
                      <div class="row">
                          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group" id="div_id_antecedente" hidden >

                            </div>
                            <div class="form-group">
                                <input name="nombre" id="nombre" type="text" class="form-control" placeholder="Antecendente" value="" required>
                            </div>
                              <div class="form-group">
                      ...
                      <div class="sparkline13-list">
                          <div class="sparkline13-hd">
                              <div class="main-sparkline13-hd">
                                  <h1>Antecedentes <span class="table-project-n">Patologicos</span></h1>
                              </div>
                          </div>
                          <div class="sparkline13-graph">
                              <div class="table-responsive datatable-dashv1-list custom-datatable-overright">
                                  <table id="table_antecedentes" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                      <thead>
                                          <tr>
                                              <th>#</th>
                                              <th>Creado</th>
        ...
        <!-- paciente JS
    		============================================ -->
        <script src="ajax/antecedente.js"></script>
